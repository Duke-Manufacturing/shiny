...
public static class PeripheralExtensions
{
    ...
    public static Task<BleCharacteristicResult> WriteCharacteristicAsync(this IPeripheral peripheral, BleCharacteristicInfo info, byte[] data, bool withResponse = true)
    => peripheral.WriteCharacteristicAsync(info.Service.Uuid, info.Uuid, data, withResponse);
